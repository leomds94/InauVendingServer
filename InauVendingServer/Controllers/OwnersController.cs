...
namespace InauVendingServer.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OwnerId,OwnerName,OwnerAddress")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("OwnerId,OwnerName,OwnerAddress")] Owner owner)
        {
            if (id != owner.OwnerId)
            {
                return NotFound();
        ...
        private bool OwnerExists(short id)
        {
